...
const searchInput = document.getElementById("searchInput"); // Tracks your top-left search input box
...
function renderCatalog() {
  ...
  if (filteredProducts.length === 0) {
    catalog.innerHTML = "<p class='no-results'>No matching items found.</p>";
    return;
  }
...
// (Keep your existing functions here like renderCart(), renderSuggestions(), renderBox() etc.)
function renderCart() {}
